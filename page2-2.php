      ...
      <div id="contentWrapper">
        ...
        <div class="gallery">
          <a target="_blank" href="sea.png">
            <div class="con">
              <img  class="mySlides" src="น้ำตกธารโต1.jpg" alt="Norway" width="1000" height="300">
              <img class="mySlides" src="น้ำตกธารโต2.jpg" style="width:100%">
              <img class="mySlides" src="น้ำตกธารโต3.jpg" style="width:100%">
            </div>
        </a>
        <div class="desc"> 	น้ำตกธารโต อยู่ที่ตำบลถ้ำทะลุ ห่างจากตัวเมืองยะลาไปตามถนนสายยะลา-เบตง (ทางหลวง 410)
กิโลเมตรที่ 47-48 มีทางแยกขวาไปอีกราว 1 กิโลเมตร เป็นน้ำตกขนาดใหญ่ 7 ชั้น มองเห็นเป็นทางน้ำที่
ไหลลดหลั่นมาจากภูเขาสูง มีแอ่งน้ำซึ่งสามารถเล่นน้ำได้ โดยรอบร่มรื่นไปด้วยป่าไม้ที่อุดมสมบูรณ์ มีพันธุ์
ไม้ที่น่าสนใจมากมายรวมทั้งต้นศรียะลา หรืออโศกเหลือง ซึ่งจะออกดอกชูช่อสีเหลืองสวยงามในราวเดือน
กุมภาพันธ์ของทุกปี
        </div>
