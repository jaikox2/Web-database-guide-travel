      ...
      <div id="contentWrapper">
        ...
        <div class="gallery">
          <a target="_blank" href="sea.png">
            <div class="con">
              <img  class="mySlides" src="วัดหน้าถ่ำ1.jpg" alt="Norway" width="1000" height="300">
              <img class="mySlides" src="วัดหน้าถ่ำ2.jpg" style="width:100%">
              <img class="mySlides" src="วัดหน้าถ่ำ3.jpg" style="width:100%">
            </div>
        </a>
        <div class="desc">  “วัดคูหาภิมุข” หรือ “วัดหน้าถ้ำ” ตั้งอยู่เลขที่ 136 หมู่ 1 บ้านหน้าถ้ำ ตำบลหน้าถ้ำ อำเภอเมืองยะลา จังหวัด
ยะลา ทราบว่า พ.ศ.2390 ผู้ใหญ่บ้านอาศัยอยู่ที่บ้านหน้าถ้ำ ได้สร้างวัดคูหาภิมุข เพื่อประกอบพิธีบำเพ็ญกุศลใน
หมู่บ้าน ภายในวัดคูหาภิมุขมีถ้ำใหญ่ ประดิษฐานพระพุทธไสยาสน์ขนาดใหญ่ ภายในถ้ำยังมีหินงอกหินย้อย
และน้ำใสสะอาดไหลรินจากโขดหิน
